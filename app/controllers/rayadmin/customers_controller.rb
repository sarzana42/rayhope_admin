class Rayadmin::CustomersController < Rayadmin::RayadminController
    ...
    def customer_params
        params.require(:customer).permit(:name1, :name2, :kana1, :kana2, :zip, :address1, :address2, :address3, :tel1, :tel2, :fax, :email, :remark, :danjo, :birth, :piccus, :groupcus, :kubun, :maildm, :piccus_cache)
    end
